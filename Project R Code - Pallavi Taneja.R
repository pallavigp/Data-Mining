...
qplot(class, data=bankdata1, geom = "bar") + geom_histogram(stat = "count", fill = c("red", "green"))

#plot the gender distribution
qplot(bankdata1$SEX) + geom_histogram(stat = "count", fill = c("cyan", "pink"))

#plot the distribution of amount of given credit 
qplot(bankdata1$LIMIT_BAL, bins = 5, margins = TRUE)

#plot the boxplot for amount of given credit and how it differs for each class
